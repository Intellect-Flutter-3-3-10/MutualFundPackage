...
//       return formatter2.format(new DateTime.fromMillisecondsSinceEpoch(millis * 1000));
...
//   }
//
//   static int getIntFromDate3(String date) {
//     try {
//       var formatter1 = new DateFormat("dd-MM-yyyy HH:mm:ss");
//       DateTime startDate = formatter1.parse(date);
...
//       var formatter2 = new DateFormat(format);
//
//       int millis = ((timeInSeconds * 1000) + startDate!.millisecondsSinceEpoch).toInt();
...
//   }
//
//   static int getIntFromDate2Chart(String date) {
//     try {
