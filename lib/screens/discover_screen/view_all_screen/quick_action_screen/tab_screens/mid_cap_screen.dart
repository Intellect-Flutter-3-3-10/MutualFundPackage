...
class MidCapScreen extends StatefulWidget {
  const MidCapScreen({super.key});

  @override
  State<MidCapScreen> createState() => _MidCapScreenState();
}

class _MidCapScreenState extends State<MidCapScreen> {
  List<bool>? _isSaved;
