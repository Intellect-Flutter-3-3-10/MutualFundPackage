...
class SmallCapScreen extends StatefulWidget {
  const SmallCapScreen({super.key});

  @override
  State<SmallCapScreen> createState() => _SmallCapScreenState();
}

class _SmallCapScreenState extends State<SmallCapScreen> {
  List<bool>? _isSaved;
